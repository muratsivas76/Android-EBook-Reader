...
implements Serializable
{
    ...
    private static final String OLDNAME="net.murat.ebook";
    private static final String OLDNAME2="net_murat_ebook";
	private static final String OLDNAME2X="net/murat/ebook";    
	private static final String SAFIS=".sayfas.*;";
	
    private static final String OLDNAME4="bin_EBook.apk";
	private static final String OLDNAME4X="bin/EBook.apk";
	...
	while ( (line=br.readLine ()) != null)
	{
	    ...
	    {
		line=line.replaceAll (OLDNAME, "net.murat."+packageName+".ebook");
	    }
	    
	    if (line.indexOf (OLDNAME2X) >= 0)
	    {
		line=getMLine (line);
		line=line.replace (OLDNAME2, "net/murat/"+packageName+"/ebook");
		line=getTLine (line);
		...
		{
			line="import net.murat."+packageName+".sayfas.*;";
		}
	...
	if (args.length < 1)
	{
	    System.out.println ("Usage:\n\tjava -cp cls; DesignPackage [<newPackageName>]");
	    System.out.println ("Example:\n\tjava -cp cls; DesignPackage atcero");
	    System.exit (-1);
	}
