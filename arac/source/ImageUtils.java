...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        // Kullanıcı en azından resim dosyasını girmiş mi kontrol et
        if (args.length < 1) {
            System.out.println("Error: Please provide at least the image file path.");
            System.out.println("Usage 1 (Default 6,6,500,500): java ImageUtils garden.png");
            System.out.println("Usage 2 (Custom coordinates): java ImageUtils garden.png [x] [y] [width] [height]");
            System.out.println("Example 2: java ImageUtils garden.png 10 10 400 400");
            return;
        }
        ...
        try {
            ...
            System.out.println(String.format("Cropped area parameters -> X: %.1f, Y: %.1f, Width: %.1f, Height: %.1f", x, y, width, height));
    ...
    private static String createOutputFileName() {
        return "../res/drawable/ebooklogo.png";
    }
