...
final
public class RemoveStartLines
extends Object
implements Serializable
{

    private RemoveStartLines ()
    {
	super ();
    }
	...
	if (args.length < 5)
	{
	    System.out.println ("Usage:\n\tjava -cp cls: RemoveStartLines [<src>] [<dst>] [<srcCharCode>] [<dstCharCode>] [<linesContainsThisExp>]\n");
	    System.out.println ("Example:\n\tjava -cp cls: RemoveStartLines src.txt dst.txt UTF-8 ISO-8859-9 Merhaba_Arkadasss\n");
	    System.out.println ("Explication:\n\tAbove example removes lines starts with \"Merhaba Arkadasss\" from src file.\n");
