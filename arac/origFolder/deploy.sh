...
# ==============================================================================
# Project: EBook Reader Java Deployment Script
...
echo "===================================================="
echo "🚀 Starting Java EBook Reader deployment pipeline..."
echo "===================================================="
...
git commit -m "Java Android EBook Reader"
...
git remote add origin https://github.com/muratsivas76/Android-EBook-Reader.git
