...
implements Serializable
{
	...
	new File ("../src/net/murat/sayfas/AInfos.java"),
	new File ("../src/net/murat/sayfas/ASayfa.java"),
	new File ("../src/net/murat/sayfas/ASayfa_00000.java"),
	new File ("../src/net/murat/sayfas/Sayfa_00001.java"),
	new File ("../src/net/murat/sayfas/Sayfa_00002.java"),
	new File ("../src/net/murat/sayfas/Sayfa_00003.java"),
	new File ("../src/net/murat/sayfas/Sayfa_00004.java"),
	new File ("../src/net/murat/sayfas/Sayfa_00005.java"),
	new File ("../clean.sh"),
	...
	new File ("origFolder/src/net/murat/sayfas/AInfos.java"),
	new File ("origFolder/src/net/murat/sayfas/ASayfa.java"),
	new File ("origFolder/src/net/murat/sayfas/ASayfa_00000.java"),
	new File ("origFolder/src/net/murat/sayfas/Sayfa_00001.java"),
	new File ("origFolder/src/net/murat/sayfas/Sayfa_00002.java"),
	new File ("origFolder/src/net/murat/sayfas/Sayfa_00003.java"),
	new File ("origFolder/src/net/murat/sayfas/Sayfa_00004.java"),
	new File ("origFolder/src/net/murat/sayfas/Sayfa_00005.java"),
    ...
    final
    private static void control (File src, File dst, String info)
    throws IOException
    {
